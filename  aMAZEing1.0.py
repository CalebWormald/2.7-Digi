...
def main():
    ...
    print("""To play this game you told "You can go" then the directions you can
go N=North, E=East, W=West and S=South.
To go the direction just enter the first letter of the direction you wish to go.
